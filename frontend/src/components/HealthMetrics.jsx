...
const HealthMetrics = () => {
    ...
    const fetchLatestMetrics = async () => {
        try {
            ...
            setToastMessage('Failed to fetch latest metrics');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.status === 201 || response.status === 200) {
                ...
                setError('');
                setToastMessage('Health metrics saved successfully!');
            ...
            setToastMessage('Failed to save metrics. Please try again.');
            setToastVariant('danger');
            setShowToast(true);
        }
    };
